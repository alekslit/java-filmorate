...
// класс для хранения строк основных SQL запросов:
public class SqlQuery {
    /*----Запросы для объектов Film и таблицы films----*/
    ...
    // к этому запросу добавляется сортировка по году или лайкам внутри метода:
    ...
    /*----Запросы для объектов User и таблицы users----*/
    ...
    /*----Запросы для объектов Genre и таблицы genre----*/
    ...
    /*----Запросы для объектов Mpa и таблицы mpa_rating----*/
    ...
    /*----Запросы для объектов Event и таблицы event_feed----*/
    public static final String SQL_QUERY_GET_EVENT_FEED =
            "SELECT * " +
            "FROM event_feed " +
            "WHERE user_id = ?;";

    /*----Запросы для объектов Director и таблицы directors----*/
    public static final String SQL_QUERY_GET_ALL_DIRECTORS =
            "SELECT * " +
            "FROM directors;";

    public static final String SQL_QUERY_GET_BY_ID_DIRECTOR =
            "SELECT * " +
            "FROM directors " +
            "WHERE directors_id = ?;";

    public static final String SQL_QUERY_UPDATE_DIRECTOR =
            "UPDATE directors SET name = ? " +
            "WHERE directors_id = ?;";

    /*----Запросы для объектов Review и таблицы reviews----*/
    public static final String SQL_QUERY_FIND_REVIEW_BY_ID =
            "SELECT * " +
            "FROM REVIEWS " +
            "WHERE review_id = ?;";

    public static final String SQL_QUERY_UPDATE_REVIEW_BY_ID =
            "UPDATE REVIEWS SET content = ?, is_positive = ? " +
            "WHERE review_id = ?;";

    public static final String SQL_QUERY_FIND_ALL_REVIEWS_BY_ID =
            "SELECT * " +
            "FROM REVIEWS " +
            "WHERE film_id = ? " +
    ...
    public static final String SQL_QUERY_FIND_ALL_REVIEWS =
            "SELECT * FROM REVIEWS " +
            "ORDER BY useful DESC " +
            "LIMIT ?;";

    public static final String SQL_QUERY_LIKE_OR_DISLIKE_REVIEW =
            "INSERT INTO review_likes (review_id, user_id, is_like) " +
            "VALUES(?, ?, ?);";

    public static final String SQL_QUERY_REMOVE_LIKE_OR_DISLIKE_FROM_REVIEW =
